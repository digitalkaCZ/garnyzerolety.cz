  ...
  <table id="pc_product_type_table" class="table borderless">
    <tbody>
        <tr>
            ...
            <td>
                <div class="form-group">
                    <input name="length_qty_vol" class="form-control pc_calculator_item_input" id="length_qty_vol" required type="text">
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="form-group">
                    <input name="width_qty_vol" class="form-control pc_calculator_item_input" id="width_qty_vol" required type="text">
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="form-group">
                    <input name="height_qty_vol" class="form-control pc_calculator_item_input" id="height_qty_vol" required type="text">
                </div>
            </td>
        </tr>
        <tr>
