<?php 
    woocommerce_wp_checkbox( array(
        ...
        'value'         => get_post_meta($post->ID, '_ext_area_lw_price_meta', true)
    ));

    echo '<hr>';

    woocommerce_wp_text_input( array(
        'id'            => '_ext_area_lw_field',
        ...
        'type'          => 'text',
        'value'         => get_post_meta($post->ID, '_ext_area_lw_field_meta', true)
    ));

    woocommerce_wp_text_input( array(
        'id'            => '_ext_area_lw_label',
        ...
        'type'          => 'text',
        'value'         => get_post_meta($post->ID, '_ext_area_lw_label_meta', true)
    )); 

    woocommerce_wp_select( array( 
        'id'            => '_ext_area_lw_unit',
        ...
        'value'         => get_post_meta( $post->ID, '_ext_area_lw_unit_meta', true )
    ));

    echo '<hr>';

    woocommerce_wp_text_input( array(
        'id'            => '_ext_area_lw_length_label',
        ...
        'type'          => 'text',
        'value'         => get_post_meta($post->ID, '_ext_area_lw_length_label_meta', true)
    ));

    woocommerce_wp_select( array( 
        'id'            => '_ext_area_lw_length_unit',
        ...
        'value'         => get_post_meta( $post->ID, '_ext_area_lw_length_unit_meta', true )
    ));

    echo '<hr>';

    woocommerce_wp_text_input( array(
        'id'            => '_ext_area_lw_width_label',
        ...
        'type'          => 'text',
        'value'         => get_post_meta($post->ID, '_ext_area_lw_width_label_meta', true)
    ));

    woocommerce_wp_select( array( 
        'id'            => '_ext_area_lw_width_unit',
        ...
        'value'         => get_post_meta( $post->ID, '_ext_area_lw_width_unit_meta', true )
    )); ?>
